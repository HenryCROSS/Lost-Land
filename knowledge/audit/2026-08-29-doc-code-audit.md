...
> **【2026-08-30 已落地：所有者裁定「按你说的」，立成第 9 条纪律。】**
> 落点是 [2026-08-28 会话交接](../handoff/2026-08-28-session-handoff.md) **第一节
> 第 9 条**「更正必须写回被更正方，两边互相指向」（不是 08-27 那一份——第一节的
> 纪律增补一直写在 08-28 那一份上，08-27 只留原始六条）。该条把本表这四例作为
> 事故记录逐条写进去了，并给出三步可执行做法：更正方写明被更正方的路径、被更正方
> 原文不动加原地更正段（什么时候 / 因为什么 / 结论现在是什么）、两边互相指向。
...
5. ~~**「更正必须写回被更正方」要不要立成第九条纪律？**（三节第 3 条）本次四类问题
   ...
   **【2026-08-30 已裁定并落地，本条关闭。】** 所有者原话「按你说的」。落点：
   [2026-08-28 会话交接](../handoff/2026-08-28-session-handoff.md) 第一节第 9 条。
   同一批还落地了本文档五节第 1 条（`lostland:finale`，所有者「改条件吧」）与
   第 2 条（`interior.rs`，所有者「重写吧」）——三条的详情见各自落点。
