...
/// # 数值从哪来（全部实测，不是拍脑袋）
///
/// 每一档的数值都在本体「标准」尺寸（96×64 区块 = 4608×3072 格）下用
/// 十个种子实测过水域比例、深水比例、山地比例、独立陆块数、最大陆块
/// 占全部陆地的比例、海岸线占陆地的比例六项，完整数据与调参过程见
...
/// |---|---|---|---|---|---|
/// | 大陆 | 37.3% | 25.5% | 3.0% | 9.4 | 98.9% |
/// | 群岛 | 72.6% | 60.2% | 1.6% | 251.6 | 8.2% |
/// | 山地 | 25.0% | 15.9% | 24.4% | 6.2 | 98.7% |
/// | 内陆 | 15.9% | 9.0% | 3.0% | 3.8 | 99.8% |
///
