...
//! # 为什么按区块代表点采样，不生成整张地图
//!
//! 「浩瀚」预设有 192×128=24576 个区块，逐瓦片生成整张地图
//! （9216×6144 格）对一条单元测试而言开销过大。[`zone_representative_terrain`]
...
/// `ll-content`」。区块边长 48：见
/// `ll_world::zone::ZoneLayout::default_config` 文档「为什么区块边长
/// 从 128 改成 48」。
